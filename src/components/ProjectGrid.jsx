...
const projects = [
  {
    ...
    fullDescription: 'A full-stack web application serving a 300+ member community with Discord OAuth, real-time character management, and administrative tools to aid in management and configuration of the county.',
